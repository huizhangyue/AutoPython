...
class SendMail:
    ...
    def sendMail(self):
        ...
        username = '15011269379@163.com'
        password = 'zhangyue521994'
...
def email():
    ...
    mail_user = "15011269379@163.com"  # 用户名
    mail_pass = "@@@@@@@@@"  # 口令

    sender = '15011269379@163.com'
    receivers = '1353407589@qq.com'  # 接收邮件，可设置为你的QQ邮箱或者其他邮箱
